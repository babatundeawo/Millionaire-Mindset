...
export function AnswerButton({
  ...
  if (isEliminated) {
    return (
      <motion.div
        ...
        className="relative"
      >
        <div className="relative px-4 py-3 sm:px-6 sm:py-5 rounded-lg border-2 border-muted bg-muted/20 opacity-40">
          <div className="flex items-center gap-3 sm:gap-4">
            <div className="flex-shrink-0 w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-muted flex items-center justify-center">
              <span className="text-base sm:text-lg font-bold text-muted-foreground">{letter}</span>
            </div>
            <span className="text-sm sm:text-lg font-semibold text-muted-foreground line-through">{text}</span>
          </div>
        </div>
      </motion.div>
    );
  ...
  return (
    <motion.button
      ...
      className={cn(
        "relative px-4 py-3 sm:px-6 sm:py-5 rounded-lg border-2 transition-all duration-300",
    ...
    >
      <div className="flex items-center gap-3 sm:gap-4">
        ...
        <span
          className={cn(
            "text-sm sm:text-lg font-semibold transition-colors duration-300 text-left",
