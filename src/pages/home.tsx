    ...
    <div className="min-h-[100dvh] w-full relative overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-[100dvh] px-4">
        ...
        >
          ...
          <div className="relative w-40 h-40 sm:w-52 sm:h-52 md:w-64 md:h-64 mx-auto mb-8">
            <motion.div
          ...
          <motion.h1
            ...
            className="text-3xl sm:text-5xl md:text-7xl font-extrabold text-foreground mb-4 tracking-tight leading-tight px-2"
          >
            WHO WANTS TO BE A
          </motion.h1>
          <motion.h2
            ...
            className="text-4xl sm:text-6xl md:text-8xl font-extrabold bg-gradient-to-r from-accent via-primary to-accent bg-clip-text text-transparent mb-8 px-2"
          >
            MILLIONAIRE?
          </motion.h2>
        </motion.div>
        ...
        >
          ...
          <Link
            href="/game"
            className="inline-block px-8 sm:px-12 py-4 sm:py-5 bg-primary text-primary-foreground text-lg sm:text-2xl font-bold rounded-lg hover:bg-primary/90 transition-all duration-300 shadow-xl shadow-primary/30 hover:shadow-2xl hover:shadow-primary/40 hover:scale-105"
